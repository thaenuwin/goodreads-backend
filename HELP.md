...
* The original package name 'com.goodreads-backend.api' is invalid and this project uses 'com.goodreadsbackend.api' instead.
...
* [Spring Security](https://docs.spring.io/spring-boot/docs/3.0.1-SNAPSHOT/reference/htmlsingle/#web.security)
