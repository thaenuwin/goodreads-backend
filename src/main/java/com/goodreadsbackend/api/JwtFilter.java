...
import com.goodreadsbackend.api.util.TokenUtil;
...
public class JwtFilter implements Filter{
    ...
    private Integer verifyJwt(String payload) {
        try {
            ...
            UserLogin userLogin =userLoginRepo.findByUserId(userId);
            Boolean validToken = userLogin.getAccessToken().equals(payload);

            if(isValid && notExpired && validToken){
                return 200;//success
            }else if(!validToken){
                return 408;
            }
